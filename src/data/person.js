...
export const personality = [
  ...
  { label: "Signo zodiacal", value: "Aries" },
  { label: "Signo chino", value: "Perro de Metal" },
  { label: "Carta astral", value: "Sol en Aries · Luna en Leo · Ascendente en Cáncer (nacido 15/04/2090, 10:10h)" },
  { label: "Miedos", value: "Altura, fracaso profesional, quedarse sin conexión a red" },
  { label: "Fetiches", value: "Tecnología retro, teclados mecánicos" },
  { label: "Objetivos", value: "Lanzar su propia startup de robótica; aprender japonés" },
  { label: "Definición de felicidad", value: "Resolver un problema difícil acompañado de buena música y su familia" },
